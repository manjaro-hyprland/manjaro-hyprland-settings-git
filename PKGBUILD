...
source=(
    "$_pkgbase::git+${url}.git#branch=hyprland"
...
package() {
    ...
    cp -r $_pkgbase/community/hyprland/etc/* "${pkgdir}/etc/"
    cp -r $_pkgbase/community/hyprland/usr/* "${pkgdir}/usr/"
